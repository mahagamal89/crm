                ...
                <form wire:submit.prevent="register">
                    ...
                    <div class="flex flex-col mb-5 max-h-10">
                        <div class="relative">
                            ...
                            <input id="password" type="password" wire:model="password" class="text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Enter password"/>
                        </div>
                        <span class="error text-xs text-red-500">
                    ...
                    <div class="flex flex-col mb-5 max-h-10">
                        <div class="relative">
                            ...
                            <input id="password_confirmation" type="password" wire:model="passwordConfirmation" class="text-sm placeholder-gray-500 pl-10 pr-4 rounded-2xl border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="confirm password"/>
                        </div>
                        <span class="error text-xs text-red-500">
